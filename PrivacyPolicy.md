...
1. _Information you provide to us._
   ...
   i. Information by which you may be personally identified, such as name, email address, telephone number, or other non-public information about you that is associated with or linked to any of the foregoing.
   ii. Player(user) name, password, and profile information;
   iii. Your messages to the Service (such as chat logs and player support tickets); and/or
   iv. Other information you voluntarily provide with us.
2. _Information we collect through automatic data collection technologies._
   ...
   i. Details of your visits to our Service, including traffic data, location data, logs, and other communication data and the resources that you access and use on the Service.
   ii. Information about your device and internet connection, including your IP address, operating system, browser type, language, and mobile device identifiers (such as your device ID, advertising ID, MAC address, IMEI);
   iii. Information about your use of the Service, such as gameplay information and your interactions with other players inside the Service; and/or
   iv. Other information we may collect automatically.
   ...
   ii. Store information about your preferences, allowing us to customize our Service according to your individual interests.
   iii. Speed up your searches.
   iv. Recognize you when you return to our Service.
...
1. _To make the Service work:_
   i. Create accounts and allow you to access our App and use our Service;
   ii. Operate the Service;
   iii. Provide and deliver products and services you request;
   iv. Send you Service-related communications;
2. _To provide a great Service to our players:_
   i. Update and develop user profiles;
   ii. Develop and improve the Service and similar our services, and player experience;
   iii. Enable you to use the augmented reality features of the Service allowing you to interact in shared worlds that blend with the real world;
   iv. Manage our relationship with you;
   v. Provide social features as part of the Service;
   vi. Customize your Service experience, including a gameplay experience tied to your real-world location;
   vii. Respond to your comments and questions and provide player support;
   viii. Provide you our offers in the Service as well as in other websites and services, and by e-mail;
   ix. Send you related information, such as updates, security alerts, and support messages;
   x. Enable you to communicate with other players;
   xi. Enable and verify certain actions;
3. _To show you personalized advertisements in the Service as well as in other websites and services (including e-mail):_
   i. Analyze the performance of the advertisements displayed in the Service;
   ii. Track the content you access in connection with the Service and your online behavior;
   iii. Deliver, target and improve our advertising and the Service;
   iv. Identify you when you are interacting with the Service on multiple devices so that we can facilitate your use of the Service and manage and analyze the performance of advertisements displayed to you.
   v. For information on how to opt-out from personalized advertisements, see section ‘Choices About How We Use and Disclose Your Information’ below.
4. _To keep the Service and its social features safe and fair, to fight fraud and ensure acceptable use otherwise:_
   i. Analyze and monitor use of the Service and its social features;
   ii. Moderate chats either automatically or manually;
   iii. Take action against fraudulent or misbehaving players;
...
1. _Tracking technologies and advertising._
   i. You can set your browser to refuse all or some browser cookies, or to alert you when cookies are being sent. If you disable or refuse cookies, please note that some parts of this site may then be inaccessible or not function properly.
   ii. You may opt-out of receiving promotional communications, such as marketing e-mails from us by following the instructions in such communications.
2. _Targeted advertising._
   i. If you do not want us to use information that we collect or that you provide to us to deliver advertisements according to our advertisers' target-audience preferences, you can opt out by checking the privacy settings of your iOS or Android device and selecting “limit ad tracking” (Apple iOS) or “opt-out of interest based ads” (Android). You can also visit the Digital Advertising Alliance (DAA) Opt-Out Page, which provides a tool that identifies its member companies that have cookies on your browser and provides links to those companies.
